...
if agreeLine1:
	...
	st.markdown("La gráfica muestra que hay poca deserción en empleados de rango de edad de 20 a 30 años de edad promedio; conforme se va incrementando la edad aumenta el indice de deserción")
	fig2,ax2 = plt.subplots(figsize=(16, 9))
	ax2.plot(showData.index,showData['Age'],color='blue')
	ax2.set_ylabel('Age',color='blue')
	ax3 = ax2.twinx()
	ax3.plot(showData.index,showData['Attrition_rate'],color='red')
	ax3.set_ylabel('Attrition_rate',color='red')
	st.pyplot(fig2)
	dataLoadState.text("Done!")
	st.markdown("___")
...
if agreeLine2:
	...
	st.markdown("Menor tiempo de servicio, poca deserción; mayor tiempo de servicio, mayor deserción")
	fig4,ax4 = plt.subplots(figsize=(16, 9))
	ax4.plot(showData.index,showData['Time_of_service'],color='blue')
	ax4.set_ylabel('Time_of_service',color='blue')
	ax5 = ax4.twinx()
	ax5.plot(showData.index,showData['Attrition_rate'],color='red')
	ax5.set_ylabel('Attrition_rate',color='red')
	st.pyplot(fig4)
	dataLoadState.text("Done!")
	st.markdown("___")
